...
const INITIAL_SECTIONS: Section[] = [
  ...
  { id: 'promo_badge', label: 'Promo Banner Badge (EN)', value: 'Special Limited Drop', type: 'text' },
  { id: 'promo_badge_bn', label: 'Promo Banner Badge (BN)', value: 'বিশেষ লিমিটেড কালেকশন', type: 'text' },
  { id: 'promo_title', label: 'Promo Banner Title (EN)', value: 'Crafted For Celebration', type: 'text' },
  { id: 'promo_title_bn', label: 'Promo Banner Title (BN)', value: 'উৎসবের জন্য বিশেষ আয়োজন', type: 'text' },
  { id: 'promo_discount', label: 'Promo Banner Discount (EN)', value: '30% OFF', type: 'text' },
  { id: 'promo_discount_bn', label: 'Promo Banner Discount (BN)', value: '৩০% পর্যন্ত ছাড়', type: 'text' },
  { id: 'promo_desc', label: 'Promo Banner Description (EN)', value: 'Experience our signature high-end cotton collections with an exclusive limited discount. Each piece is hand-tailored with premium threads.', type: 'textarea' },
  { id: 'promo_desc_bn', label: 'Promo Banner Description (BN)', value: 'আমাদের সিগনেচার হাই-এন্ড কটন কালেকশন পেয়ে যান আকর্ষণীয় মূল্যে। প্রতিটি পোশাক প্রিমিয়াম সুতা দিয়ে তৈরি।', type: 'textarea' },
  { id: 'promo_cta', label: 'Promo Banner Button Text (EN)', value: 'Shop The Collection', type: 'text' },
  { id: 'promo_cta_bn', label: 'Promo Banner Button Text (BN)', value: 'এখনই কিনুন', type: 'text' },
];
const TOGGLES = [
  { id: 'banner', label: 'Show "Free Delivery" Top Banner', default: true },
  { id: 'promo_banner', label: 'Show Homepage Promo Banner', default: true },
