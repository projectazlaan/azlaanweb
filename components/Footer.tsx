      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-10">
          ...
          <div className="col-span-2 lg:col-span-2 flex flex-col gap-3">
            <h3 className="font-sans text-xl md:text-2xl font-black uppercase tracking-tighter">Azlaan</h3>
            <p className="text-[10px] md:text-xs text-gray-400 max-w-xs leading-relaxed">
              Premium clothing brand dedicated to craftsmanship and timeless elegance.
            </p>
            <p className="text-[9px] md:text-[10px] text-gray-300 uppercase tracking-widest mt-2">
              © 2026 Azlaan Premium.
            </p>
          </div>
          {/* Company */}
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-[10px] md:text-xs text-gray-400">
